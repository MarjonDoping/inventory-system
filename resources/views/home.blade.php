            ...
            <div class="row">
             ...
             <center>
              <h2>@if($home) 
                        ...
                        @endforeach
                        @endif</h2>
                      <h6>Cletos bakery shop is a trusted and fully registered business in the heart of Urdaneta City </h6>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('detail')}}"><img src="{{asset('uploads')}}/{{$value->image}}" alt="Welcome image"></a>
                </div>
                <div class="down-content text-center">
                  <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
                  </div>
                  <a href="{{asset('detail')}}"><h4>{{$value->title}}</h4></a>
                  <div class="main-button-red">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('details')}}"><img src="{{asset('uploads')}}/{{$value->image}}" alt="Welcome image"></a>
                </div>
                <div class="down-content text-center">
                  <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('details1')}}"><img src=" {{asset('uploads')}}/{{$value->image}}" alt="Online Teaching"></a>
                </div>
                <div class="down-content text-center">
                <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
                  </div>
                  <a href="{{asset('details1')}}"><h4>{{$value->title}}</h4></a>
                  <div class="main-button-red">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('details2')}}"><img src=" {{asset('uploads')}}/{{$value->image}}" alt="Online Teaching"></a>
                </div>
                <div class="down-content text-center">
                <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
                  </div>
                  <a href="{{asset('details2')}}"><h4>{{$value->title}}</h4></a>
                  <div class="main-button-red">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('details3')}}"><img src=" {{asset('uploads')}}/{{$value->image}}" alt="Online Teaching"></a>
                </div>
                <div class="down-content text-center">
                <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
                  </div>
                  <a href="{{asset('details3')}}"><h4>{{$value->title}}</h4></a>
                  <div class="main-button-red">
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="{{asset('details4')}}"><img src=" {{asset('uploads')}}/{{$value->image}}" alt="Online Teaching"></a>
                </div>
                <div class="down-content text-center">
                <div class="date">
                    <h6>{!! $value->created_at !!}</h6> 
                  </div>
                  <a href="{{asset('details4')}}"><h4>{{$value->title}}</h4></a>
                  <div class="main-button-red">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="item">
                ...
                <p>If you want to order customize cakes and other products we offer you can message us here by clicking the button below</p>
                <div class="main-button-red">
                  <div ><a href="{{asset('contact')}}">Message us Here!</a></div>
              </div>
              </div>
              <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.739230805907!2d120.5689265290526!3d15.97498865545702!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33913fadef6bddc7%3A0xd432f6acee88724d!2sCleto&#39;s%20Bakeshop!5e0!3m2!1sen!2sph!4v1689515755299!5m2!1sen!2sph" frameborder="0" allowfullscreen></iframe>
