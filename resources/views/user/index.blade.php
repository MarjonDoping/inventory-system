...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="{{asset('homes/css/templatemo-edu-meeting.css')}}">
...
<body>
          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
                          <li class="scroll-to-section"><a href="{{asset('index')}}" class="active">Home</a></li>
                          <li><a href="{{asset('updates')}}">Updates</a></li>
                          <li class="scroll-to-section"><a href="{{asset('index')}}">Apply Now</a></li>
                          <li class="has-sub">
                              <a href="javascript:void(0)">Pages</a>
                              <ul class="sub-menu">
                                  <li><a href="{{asset('')}}">Upcoming Meetings</a></li>
                                  <li><a href="{{asset('details')}}">Meeting Details</a></li>
                              </ul>
                          </li>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      <video autoplay muted loop id="bg-video">
          <source src=" {{asset('images/vids.mp4')}} " type="video/mp4" />
      </video>
            ...
            <div class="col-lg-6">
              <div class="meeting-item">
                <div class="thumb">
                  ...
                  <a href="meeting-details.html"><img src=" {{asset('images/meeting-03.jpg')}}" alt="Higher Education"></a>
                </div>
                <div class="down-content">
                  <div class="date">
