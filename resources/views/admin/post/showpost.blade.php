...
<main>
    ...
    <a href="{{route('post-add')}}" class="btn btn-primary text-right"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
</div>
<br>
...
<table id='myTable' class='display' style='width:100%'>
    ...
    @foreach($posts as $post)
			...
			<td>
				...
				<a class="btn btn-danger btn-xs deletepost" image="{{$post->image}}" post-id="{{$post->id}}"><i class="fa fa-trash"></i></a>
			</td>
			</tr>
			@endforeach
