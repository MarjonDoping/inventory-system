...
@endif
    ...
    <a href="{{route('site-add')}}" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
</div>
<br>
<table id='myTable' class='display' style='width:100%'>
	...
	<tbody>
			...
			<td><img src="uploads/{{$site->image}}" style="height: 50px;width: 50px;"></td>
			<td>
				<a href="{{route('site-edit')}}/{{$site->id}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
				<a class="btn btn-danger btn-xs deletepost" image="{{$site->image}}" post-id="{{$site->id}}"><i class="fa fa-trash"></i></a>
			</td>
			</tr>
			@endforeach
